...
try{
 await mongoose.connect('mongodb+srv://edwinDB:pmUtCcKnxTvbFcGM@cluster0.jbuvk.mongodb.net/ecom?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}).then(()=>console.log("connected !"))
}
catch(err){
